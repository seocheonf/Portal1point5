...
void AVirtualCameraForPortal::TransformFromTargetCamera(UCameraComponent* targetCameraComp)
{
	...
	FVector baseLocalLocation = UKismetMathLibrary::InverseTransformLocation(baseTransform, targetCameraComp->GetComponentLocation());
	//이 local location을 실제 대상의 Transform을 기반으로 적용하여 world location 결정 
	FVector realLocation = UKismetMathLibrary::TransformLocation(LinkedPortal->GetActorTransform(), baseLocalLocation);
	...
	FVector baseForward = UKismetMathLibrary::GetForwardVector(targetCameraComp->GetComponentRotation());
	...
	FVector baseUp = UKismetMathLibrary::GetUpVector(targetCameraComp->GetComponentRotation());
	...
	FVector realForward = UKismetMathLibrary::TransformDirection(LinkedPortal->GetActorTransform(), baseLocalForward);
	FVector realUp = UKismetMathLibrary::TransformDirection(LinkedPortal->GetActorTransform(), baseLocalUp);
